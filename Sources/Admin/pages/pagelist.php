...
?>
				<header>
					<div class='header'>
						...
						<button class='button' style='float:right;margin-right:10px;margin-top:4px;' onclick='$("#newPage_modal").fadeIn();'><?php echo "<img src='".$connect['url']."/Sources/Admin/images/icons/add.png'>".$language['newPage']; ?></button>
					</div>
				</header>
				<div id='content'>
					<?php
					...
					<form action='./admin.php?action=newPage' method='post' id='newPageForm'>
						<div class='cont'>
							...
							<table style='width:90%;margin:0 auto;padding-top:25px;'>
								<tr>
									<td style='width:125px;'><img src='./Sources/Admin/images/icons/note.png' style='position:relative;top:3px;margin-right:3px;' /><?php echo $language['name']; ?></td>
