<?php
	$language = array(
		...
		"templateEdit" => "Edit template",
                ...
                "templateEditContainer" => "Container",
                "top, left" => "top, left",
